...
Both ``pronounce.acoustic`` and ``pronounce.phoneme`` (text-only) return
...
class PronunciationResult:
    ...
    # --- Acoustic-engine diagnostics (pronounce.acoustic); safe to ignore elsewhere. ---
    ...
    # --- Phoneme-engine diagnostics (pronounce.phoneme); safe to ignore elsewhere. ---
